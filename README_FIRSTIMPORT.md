...
- If `jsonschema` is installed and `schema/systemdef.schema.json` exists in the base path, the script will validate the
  generated JSON before writing. Add `jsonschema` to `requirements.txt` to enable validation.
