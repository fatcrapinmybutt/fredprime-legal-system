...
This repository uses **100% open-source, free tools** for enforcing code quality and repository standards without requiring GitHub API access or admin permissions.
