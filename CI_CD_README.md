...
This project implements a **multi-layered, open-source CI/CD pipeline** combining GitHub Actions
with optional Drone CI for maximum flexibility and no vendor lock-in.
