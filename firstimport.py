...
litigation_system_definition = {
    ...
    "modules": {
        "exhibit_labeler": (
            "Renames evidence files A–Z and builds " "Exhibit_Index.md"
        ),
        ...
        "appclose_matrix": (
            "Parses AppClose logs to generate Exhibit Y (violations matrix)"
        ),
        "conspiracy_log": (
            "Parses police reports and logs false allegations into Exhibit S"
        ),
    },
